...
if __name__ == '__main__':
    ...
    dim = 3
    model_csv = True
    biomakrer_zoo = [['SYN'], ['BME']] # ['TSY'], 'SYN', 'TSY', 'BME',  ['SYN', 'TSY', 'BME'] #['TSY']#['SYN'], ['TSY'], ['BME']] #  , 
    ...
    #         #     print('======================================================1=======================================================')
    #         #     continue
    #         dirc = ['COR'] if bio in [['SYN'], ['BME']] else ['TRA', 'COR']
    #         ramris3d_pred_runner(data_dir=data_dir, target_category=None, target_site=site, target_dirc=dirc, 
