...
if __name__ == '__main__':
    ...
    for task in task_zoo:
        medical_runner(target_category=None, task=task, dataset_split='val', cam_save=False, eval_flag=eval_act)
    
    esmira_runner(target_category=None, data_dir='D:\\ESMIRA\\ESMIRA_common',
                  target_catename=['CSA'], target_site=['Wrist'], target_dirc=['TRA', 'COR'], cam_save=True, eval_flag=eval_act)
