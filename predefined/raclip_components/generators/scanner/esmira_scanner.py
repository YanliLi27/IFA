...
from predefined.raclip_components.generators.scanner.scanner_utils.central_slice import central_selector
from predefined.raclip_components.generators.scanner.scanner_utils.ramris_reader import ramris_reader
from predefined.raclip_components.generators.scanner.scanner_utils.ramris_search import ramris_search
...
def esmira_scanner(data_root:str, common_dict:dict) ->pd.DataFrame:
    ...
    RAMRIS_dir = 'D:\\ESMIRA\\SPSS data' if platform.system().lower()=='windows' else '/exports/lkeb-hpc/yanli/SPSS data'
    df_eac, df_csa, df_atl = ramris_reader('EAC', ramris_root=RAMRIS_dir), ramris_reader('CSA', ramris_root=RAMRIS_dir), ramris_reader('ATL', ramris_root=RAMRIS_dir)  # drop the useless information
