...
def _common_list_finder(init_dict:dict, working_dir:str='.', data_root:str='') ->dict:
    dict_path = f'{working_dir}/generators/scanner/logs/{data_root[-4:]}_img_id_list.pkl'
...
def ramris_id_filter(img_id_dict:dict, ramris_root:str='D:\\ESMIRA\\SPSS data') ->dict:
    target_category = ['EAC', 'CSA', 'ATL']
    ...
    for cate in target_category:
        ...
        RAMRIS_path = os.path.join(ramris_root, chosen_ramris)
