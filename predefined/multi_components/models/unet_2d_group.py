...
class Classifier(nn.Module):
    def __init__(self, num_classes=2, group_num=2, init_weights: bool = True):
...
class ModelClass(nn.Module):
    def __init__(self, img_ch=5, output_ch=1, encoder=Encoder, classifier=Classifier, group_num=2, init_weights: bool = True):
